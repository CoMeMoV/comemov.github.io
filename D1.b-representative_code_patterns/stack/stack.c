...
#define GET_COLLECTIONSIZE(idx) (((RegistryCell*)Registry)[idx].CollectionSize)
#define GET_COLLECTIONMAXSIZE(idx) (((RegistryCell*)Registry)[idx].CollectionMaxSize)
// #define SET_COLLECTIONSIZE(ptr,size) (((RegistryCell*)ptr)->.CollectionSize = size)
// #define SET_COLLECTIONMAXSIZE(ptr,maxsize) (((RegistryCell*)ptr)->CollectionMaxSize = maxsize)
...
int push_collection(uchar collection_max_size){
  ...
  ((RegistryCell*) NextFreeRegister)->CollectionSize = NextFreeCell - CurrentCollectionStart;
  ((RegistryCell*) NextFreeRegister)->CollectionMaxSize = CurrentCollectionMaxSize;
...
int pop_collection(){
  ...
  CurrentCollectionStart -= ((RegistryCell*)NextFreeRegister)->CollectionSize;
  CurrentCollectionMaxSize = ((RegistryCell*)NextFreeRegister)->CollectionMaxSize;
